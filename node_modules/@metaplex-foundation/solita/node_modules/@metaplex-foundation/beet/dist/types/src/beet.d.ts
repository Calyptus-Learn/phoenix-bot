 ...
 */
export declare type BeetTypeMapKey = CollectionsTypeMapKey | StringTypeMapKey | CompositesTypeMapKey | EnumsTypeMapKey | NumbersTypeMapKey | AliasesTypeMapKey;
/**
 * @category TypeDefinition
 */
export declare type BeetExports = CollectionsExports | StringExports | CompositesExports | EnumsExports | NumbersExports | AliasesExports;
/**
